...
<div class="sm:text-center lg:text-left">
  ...
  <p
    ...
    sm:max-w-5xl">
    At the heart of everything we do, you can find our THAT Community Geeks. We
    absolutely love our community of Geeks. Everyone brings a unique skill set
    and background that enriches our conversations and relationships. If you
    haven’t already signed up why wait any longer?
  </p>
