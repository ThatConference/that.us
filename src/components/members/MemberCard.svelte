...
<div class="h-full text-center bg-white rounded-lg shadow transform hover:scale-110 hover:bg-that-offWhite ">
  <div class="p-4 flex flex-col">
    <div>
        ...
        <h3 class="mt-4 text-gray-900 text-sm leading-5 font-medium">
          {`${firstName} ${lastName}`}
        </h3>
      </div>
      <div class="flex-grow">
