...
{#await queryEvent() then event}
  <div class="flex flex-col justify-center">
    <div class="relative py-3 sm:max-w-xl sm:mx-auto">
      <div
        class="absolute inset-0 bg-gradient-to-r from-thatBlue-400 to-thatBlue-700 shadow-lg transform -skew-y-6 sm:skew-y-0 sm:-rotate-6 sm:rounded-3xl">
      </div>
        ...
        <div class="max-w-md mx-auto">
          ...
          <div class="divide-y divide-gray-200">
            <div
              ...
              <div>
                <span class="font-extrabold text-that-red"
                  >Tickets are on sale.</span>
                Keynotes, Workshops, Sessions, Open Spaces, a pig roast, and even
                a Waterpark party. Hurry camp starts soon!
              </div>
