  ...
  <main class="flex-grow overflow-hidden">
    <div class="hidden lg:block lg:inset-y-0 lg:h-full lg:w-full">
      <div
        ...
        <div
          class="fixed w-4/6 h-5/6 right-0 mt-40 mr-80 lg:bottom-4/12 lg:left-5/12 lg:mt-0 lg:mr-0">
          <div class="back"></div>
        </div>
        <slot />
      </div>
...
<style>
  .back {
    ...
    height: 100%;
    width: 100%;
    background-image: url(/images/logos/logo-javascript.svg) top center;
    background-size: 100%;
  }
</style>
