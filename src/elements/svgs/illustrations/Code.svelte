...
<svg
  ...
  <path
    ...
    class="st0"
    d="M730.5,452.5c-12.7-7.4-21.9-7.6-27.6-0.6c-5.7,6.9-8.5,18.6-8.5,35.1v88.9c0,16.9-1.6,30.9-4.7,42
  ...
  <path
    ...
    class="st1"
    d="M408,195c12.7,7.4,21.9,7.6,27.6,0.6c5.7-6.9,8.5-18.6,8.5-35.1V71.6c0-16.9,1.6-30.9,4.7-42
  ...
  <path
    ...
    class="st2"
    d="M690.5,482.5c-12.7-7.4-21.9-7.6-27.6-0.6c-5.7,6.9-8.5,18.6-8.5,35.1v88.9c0,16.9-1.6,30.9-4.7,42
	c-3.1,11.5-8.4,19.7-15.7,24.5c-7.1,4.9-16.7,6.2-28.9,3.9c-11.9-2.2-26.8-8.4-44.6-18.7l-8.5-4.9v-70l10.6,6.1
	c12.7,7.4,21.2,8.3,25.5,2.9c4.5-5.2,6.8-16.1,6.8-32.6v-78.3c0-20.4,2-36.5,6-48.4s11.9-19.4,23.8-22.8
	c-11.9-17.1-19.8-33.8-23.8-50.2c-4-16.4-5.9-34.8-5.9-55.2v-78.3c0-16.5-2.3-29.9-6.8-40.4c-4.2-10.3-12.7-19.1-25.5-26.5
	l-10.6-6.1v-70l8.5,4.9c17.8,10.3,32.7,21.2,44.6,32.8c12.2,11.7,21.8,24.2,28.9,37.3c7.4,13.3,12.6,27.5,15.7,42.6
  ...
  <path
    in:fly="{{ x: 150, duration: 2000 }}"
    class="st3"
    d="M368,225c12.7,7.4,21.9,7.6,27.6,0.6c5.7-6.9,8.5-18.6,8.5-35.1v-88.9c0-16.9,1.6-30.9,4.7-42
	c3.1-11.5,8.2-19.8,15.3-24.7c7.4-4.8,17-6.1,28.9-3.9c12.2,2.3,27.2,8.6,45,18.9l8.5,4.9v70l-10.6-6.1c-12.7-7.4-21.4-8.4-25.9-3.2
	c-4.2,5.4-6.4,16.3-6.4,32.8v78.3c0,20.4-2,36.5-6,48.4c-4,11.8-11.9,19.4-23.8,22.8c11.9,17.1,19.8,33.8,23.8,50.2
	c4,16.4,5.9,34.8,5.9,55.2v78.3c0,16.5,2.1,29.9,6.4,40.2c4.5,10.5,13.2,19.4,25.9,26.7l10.6,6.1v70l-8.5-4.9
	c-17.8-10.3-32.8-21.3-45-33c-11.9-11.6-21.5-24-28.9-37.3c-7.1-13.1-12.2-27.2-15.3-42.4c-3.1-14.7-4.7-30.6-4.7-47.4v-88.9
  ...
  ></path>
  <path
    in:fly="{{ x: -100, y: -100, duration: 2000 }}"
    class="st5"
    d="M113.9,75.1l135.9,78.5v37.7l-135.9-78.5L113.9,75.1z"></path>
  <path in:fade class="st6" d="M167,167.8l130.8,75.5v13.6L167,181.5V167.8z"
  ></path>
  <path
    in:fade="{{ delay: 300 }}"
    class="st6"
    d="M167,194.4l113.1,65.3v13.6L167,208V194.4z"></path>
  <path
    in:fade="{{ delay: 600 }}"
    class="st6"
    d="M167.1,238.7l130.6,75.4v58.6l-130.6-75.4V238.7z"></path>
  <linearGradient
    id="SVGID_6_"
    gradientUnits="userSpaceOnUse"
    x1="204.6561"
  ...
  <path class="st7" d="M146,12.2l170.9,98.7v54.9L146,67.1V12.2z"></path>
  <path
    class="st8"
    d="M188.7,64.6c0,8.3-4.9,12.2-10.9,8.8c-6-3.5-10.8-13-10.8-21.3s4.9-12.2,10.9-8.8
  ...
  <path
    ...
    class="st9"
    d="M356,391.7l170.9,98.7l-0.1,409.3L355.9,801L356,391.7z"></path>
  <path
    in:fly="{{ x: 100, y: 100, duration: 2000 }}"
    class="st10"
    d="M421.1,510.8L557,589.2v37.6l-136-78.4L421.1,510.8z"></path>
  <path
    in:fade="{{ delay: 500 }}"
    class="st6"
    d="M377.1,549.7l130.7,75.5v58.5l-130.7-75.5L377.1,549.7z"></path>
  <path
    in:fade="{{ delay: 1000 }}"
    class="st6"
    d="M376.9,633.3l130.8,75.5v13.6L376.9,647V633.3z"></path>
  <path
    in:fade="{{ delay: 1500 }}"
    class="st6"
    d="M376.9,657.9L490,723.2v13.6l-113.1-65.3V657.9z"></path>
  <linearGradient
    id="SVGID_8_"
    gradientUnits="userSpaceOnUse"
    x1="414.6631"
  ...
  <path class="st11" d="M356,391.7l170.9,98.7v54.9L356,446.6L356,391.7z"></path>
  <path
    class="st8"
    d="M398.7,444.2c0,8.3-4.9,12.2-10.9,8.8c-6-3.5-10.8-13-10.8-21.3s4.9-12.2,10.9-8.8
  ...
  ></path>
  <path in:fade class="st6" d="M249.9,442l-65.2-37.6V418l65.2,37.6V442z"></path>
  <path
    in:fade="{{ delay: 500 }}"
    class="st6"
    d="M249.9,469.3L88.5,376.1v13.6L250,482.9L249.9,469.3z"></path>
  <path
    in:fade="{{ delay: 1000 }}"
    class="st6"
    d="M250,496.6L55.1,384.1v13.6L250,510.2V496.6z"></path>
  <path
    class="st10"
    d="M266,465.5c0,12.8,7.6,27.5,16.9,32.9s16.9-0.6,16.9-13.4s-7.6-27.5-16.9-32.9
	C273.5,446.7,266,452.7,266,465.5z"
  ></path>
  <path
    class="st6"
    d="M58.3,167.8L18.9,145v-13.3l39.4,22.8c3.2,1.9,7.9,5.6,11.9,11.4c4.3,6.2,7.4,14,7.4,22.5
  ...
  <path
    class="st13"
    d="M109.6,256.4c0,11.4-6.7,16.7-14.9,12s-14.9-17.8-14.9-29.2s6.7-16.7,14.9-12
  ...
  <path
    class="st14"
    d="M215.9,604.1c6,3.5,10.8,11.8,10.8,18.8v30.5l20.2,11.6c6,3.5,10.8,11.8,10.8,18.8c0,6.9-4.9,9.7-10.8,6.3
