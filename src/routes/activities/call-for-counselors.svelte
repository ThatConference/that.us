<script>
	...
	import EventMeta from './_components/cfp/_EventMeta.svelte';
	import CTA from './_components/cfp/_CTA.svelte';
              ...
              sm:leading-none md:text-6xl"
					...
					<div class="space-y-8 col-span-3">
						<p class="prose-2xl text-gray-500">
							Are you ready to speak at the biggest tech conference in the US Midwest? We are
							searching for hour-long sessions, half and full-day workshops, and keynotes that bring
							value to our community. The sessions and workshops can appeal to developers,
							designers, testers, business owners, site builders, community organizers, and
					...
					<div class="lg:grid lg:grid-cols-5 lg:gap-8 lg:items-start">
						...
						<div class="col-span-3">
							<p class="prose-xl text-white">
								...
								backgrounds. Do you have a story to tell? Do you have expertise in a specific field
				...
				<div class="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 ">
					...
					<div class="mt-12">
						<p class="text-center pt-4 prose-lg text-gray-500">
							Dare we say we've gone "digital-first"? Sounds fancy, right? The truth is we're a
							believer in continuous refactoring, and let's be honest, the resort isn't big enough
							for the camp we want to set up. THAT Conference is now comprised of two primary
							delivery methods, online or in-person.
						</p>
						...
						<div class="pt-12 flex">
							<p class="flex-grow text-left pt-4 prose-lg text-gray-500">
								In-person activities are just that; they're physically in-person and also authentic
								to their audience. Typically they're orchestrated with a single speaker and limited
								by time and physical space.
							</p>
							<div class="flex flex-col justify-center">
								<img
						...
						<div class="mt-8 flex flex-col space-y-6">
							...
							<div>
								...
								<p class="pt-4 prose-lg text-gray-500">
									THAT Conference is a professional polyglot technical conference with a rich
									experience for children and other family members. Your session could be aimed at
									the professional track or for family "geeklings".
								</p>
							</div>
							...
							<div>
								...
								<p class="pt-4 prose-lg text-gray-500">
									Standard sessions are 60 minutes each, including time for answering questions.
									There is a 30-minute break in-between each session to nurture those all-important
							...
							<div>
								...
								<p class="pt-4 prose-lg text-gray-500">
									Half-day (four hours) or full-day (8 hours), the day leading into THAT Conference
									is set aside for a full day of workshops. Be prepared to provide attendees a
									decent agenda for what you'll cover.
								</p>
							</div>
							...
							<div>
								...
								<p class="pt-4 prose-lg text-gray-500">
									Do you have what it takes to give a 90-minute speech on something you're
									passionate about? You'll have an audience of over 1,000 people in front of the
									stage listening to your story. We want topics that'll motivate, energize, and help
									attendees see the world differently as the diverse place it is.
								</p>
							</div>
						</div>
