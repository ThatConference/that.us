...
<div class="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 ">
  ...
  <!-- 
  <div>
    <p class="text-center pt-4 prose-lg text-gray-500">WRITE THIS</p>
  </div> 
  -->
  ...
  <div class="mt-24 grid grid-cols-1 gap-8 gap-y-24 sm:grid-cols-3">
    <Link href="/events/{event.slug}">
      <div
        ...
        <div class="-mt-16 flex flex-col justify-center">
          <img
            src="/images/characters/conference_ticket.svg"
            class="h-48"
            alt="" />
        </div>

        <p
          class="py-4 text-center text-lg font-extrabold tracking-wide text-gray-600">
          Conference Ticket
        </p>

        <p class="prose text-center text-gray-500">
          To attend all 4 days of THAT Conference! Including all conference
          meals, THAT Pig Roast and all social/networking activities!
        </p>
      </div>
    </Link>
    ...
    <Link href="/support/travel">
      <div
        ...
        <div class="-mt-16 flex flex-col justify-center">
          <img
            src="/images/characters/hotel_accomodations.svg"
            class="h-48"
            alt="" />
        </div>
    ...
    <Link href="https://store.thatconference.com" open>
      <div
        class="h-full p-8 bg-gray-50 rounded-md shadow-md transition duration-500 ease-in-out transform hover:scale-105">
        <div class="-mt-16 flex flex-col justify-center">
          <img
