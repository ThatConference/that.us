...
<div class="px-4 sm:px-6">
	<div class="mt-6 grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-6">
		...
		<div class="sm:col-span-6">
			<label for="activity_short_description" class="block text-sm font-medium text-gray-700">
				Short Description
			</label>
			<div class="relative">
				<span
		...
		<div class:hidden={['DAILY', 'ONLINE'].includes(eventType)} class="sm:col-span-6">
			<label for="activity_long_description" class="block text-sm font-medium text-gray-700">
				Full Description
			</label>
			<div class="relative">
				<span
			...
			<div>
				<p class="mt-1 text-sm text-gray-400">
					No holding back. Describe what this activity is all about and why people should attend.
				</p>
			</div>
			<div class="mt-4">
				<Input
