...
<section class="py-16 lg:py-20 bg-that-offWhite">
  ...
  >
    <svg
      class="absolute top-0 left-0 transform -translate-x-12 -translate-y-8
        h-16 w-16 text-thatBlue-500"
      stroke="currentColor"
      fill="none"
      viewBox="0 0 144 144"
    >
      <path
        ...
        d="M41.485 15C17.753 31.753 1 59.208 1 89.455c0 24.664 14.891 39.09
          32.109 39.09 16.287 0 28.386-13.03 28.386-28.387
    ...
    <h2
      class="text-3xl leading-9 font-extrabold tracking-tight text-thatBlue-500
