			...
			<table class="h-px w-full ">
				...
				<thead>
					<tr>
						...
						{#each ticketBreakdown as ticket}
							<th
								class="px-6 pb-4 text-center align-top text-lg font-medium leading-6 text-gray-900"
						...
						{#each ticketBreakdown as ticket}
							<td class="h-full px-6 py-8 align-top">
								<div class="flex h-full flex-col items-center">
									...
									<p class="mt-4 flex-grow text-center text-sm text-gray-500">
										{eventTickets[ticket.uiReference].shortDescription}
									</p>
				...
				<tfoot>
					<tr class="border-t border-gray-200">
						...
						<td class="px-6 pt-12 text-center">
