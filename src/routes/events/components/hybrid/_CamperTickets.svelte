  ...
  <div class="bg-thatBlue-800 pt-12 px-4 sm:px-6 lg:px-8 lg:pt-20">
    <div class="relative flex flex-col items-center justify-center space-y-12">
      ...
      <p
        ...
        across various technologies, platforms, and disciplines of all levels.
        You can also access over 10,000 sq. ft. of open spaces to participate in
        more intimate discussions across all topics you and your fellow
        attendees generated. All sessions, including open spaces, are designed
              ...
              <div class="flex-1 flex flex-col">
                    ...
                    <div class="mt-4 flex items-center justify-center">
                      <span
                        ...
                        <span class="font-extrabold"
                          >{eventTickets['WORKSHOPS'].price}</span>
                        <span
                ...
                <div
                  ...
                  <div class="mt-8">
                    <div class="flex flex-col">
                      <StandardButton
                        on:click="{() => handleTicketPurchase('WORKSHOPS')}">
                        Purchase
                      </StandardButton>
                    </div>
                  </div>
              ...
              <div
                ...
                <div class="mt-10">
                  <div class="flex flex-col">
                    <HighlightButton
                      on:click="{() =>
                        handleTicketPurchase('EVERYTHING_CAMPER')}">
                      Purchase
                    </HighlightButton>
                  </div>
                </div>
                ...
                <div
                  ...
                  <div class="mt-8">
                    <div class="flex flex-col">
                      <StandardButton
                        on:click="{() =>
                          handleTicketPurchase('VIRTUAL_CAMPER')}">
                        Purchase
                      </StandardButton>
                    </div>
                  </div>
