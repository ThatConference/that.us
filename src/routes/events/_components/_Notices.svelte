	...
	<div class="bg-white px-12 py-6 flex flex-col justify-start rounded-lg shadow-lg space-y-12">
		...
		>
			<div>
				...
				<div class="mt-4 prose text-lg text-gray-500">
					While THAT Conference 2021 will be held as a digital-first platform, we are committed to
					the health and safety of all in-person participants of the conference. We are constantly
					monitoring the CDC guidelines and working with the Kalahari Meeting and Convention team to
					accommodate healthy practices in the convention center.
				</div>
			</div>
