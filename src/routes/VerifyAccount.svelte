  ...
  <div class="max-w-max mx-auto">
    <main class="sm:flex">
      <div>
        <img
          class="h-28"
          src="/images/characters/Preston@2x.png"
      ...
      <div class="sm:ml-6">
        <div class="sm:border-l sm:border-gray-200 sm:pl-6">
          <div class="flex">
            <div>
              <h1
                class="text-4xl font-extrabold text-thatBlue-800 tracking-tight sm:text-5xl">
                THAT Account Unverified
              </h1>
              <p class="max-w-3xl mt-1 text-base text-gray-500">
                You account is current unverified. To continue please check your
                email and finish verification or if you think you're seeing this
                in error, ask us in chat, or email us at
                <a
