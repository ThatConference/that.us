  ...
  <section>
    <div class="prose prose-lg text-gray-500 mx-auto">
      ...
      <p>
        ...
        as we call it, is your main place to find out what's up next. It will always
        show all Activities from today looking forward. You can also find
      ...
      <p>
        ...
        is just like the Activity Board but filtered to the Activities you've already
        favorited. This is great during times of high usage or for historical reasons.
      </p>

      <h2>Calendar Feed</h2>
      <p>
        Most people live by their calendars. We've created a shared Google
        calendar that you can subscribe to. This calendar is updated as
      ...
      <p>
        ...
        real-time updates when the Activities are created but will also send a
      ...
      <p>
        ...
        It's our goal to connect you to the relevant topics and help you grow
