...
<footer class="bg-white border-t border-gray-200 z-10" aria-labelledby="footerHeading">
	...
	<div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
		<div class="xl:grid xl:grid-cols-3 xl:gap-8">
			...
			<div class="mt-12 grid grid-cols-2 gap-8 xl:mt-0 md:col-span-2">
				<div>newsletter signup</div>
			</div>
		</div>

		<div class="col-span-3 mt-12 pt-12 grid grid-cols-3 gap-8 xl:mt-0">
					...
					<ul class="mt-6 space-y-4">
						{#each thatLinks as thatLink}
							<li>
								<a
									href={thatLink.href}
									class="text-base text-gray-500 hover:text-that-blue focus:border-thatOrange-700 focus:ring-that-orange"
								>
									{thatLink.text}
								</a>
							</li>
